...
function play() {
    var user_guess = document.getElementById("guessno").value;
    if (user_guess < 1 || user_guess > 100) {
        ...
        if (user_guess < answer) {
            ...
            msg2.textContent = "No. Of Guesse : " + no_of_guesses;
            msg3.textContent = "Guessed Number Are: " + guesses_num;
        } else if (user_guess == answer) {
            msg1.textContent = "Yah You won It!!"
            msg2.textContent = "The Number was " + answer; msg3.textContent = " You guess number in " + no_of_guesses + "Guesses";
        }
    }
}
